...
export default function HotTemplate() {
  ...
  return (
    <section id="templates" className="relative py-16 sm:py-20 bg-white">
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <div
            ref={scrollRef}
            className="flex gap-4 sm:gap-5 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-4 -mx-4 px-4"
          >
            {templates.map((template, index) => (
              ...
              >
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden ring-1 ring-black/5">
                  {/* Image */}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    ...
                    {/* Preview button — reveal on hover */}
            ...
            {templates.map((_, index) => (
              <button
                ...
                className={`h-1.5 rounded-full transition-all duration-500 ${
                  index === activeIndex
                    ? 'w-6 bg-[#C6A769]'
                    : 'w-1.5 bg-[#1C1C1C]/10 hover:bg-[#1C1C1C]/20'
                }`}
              />
            ))}
          </div>
          ...
          <div className="hidden sm:flex items-center justify-center gap-3 mt-5">
            ...
            >
              <svg className="w-4 h-4 text-[#C6A769]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        >
          <a
            href="#"
            className="group inline-flex items-center gap-2 text-[#6B6B6B] text-[11px] tracking-[0.2em] uppercase hover:text-[#C6A769] transition-colors duration-300"
          >
